...
#### Visualise the data
```{r}
data <- read.csv("Data/aluminium.csv")

library(ggplot2)

data |> ggplot(aes(x=strain,y=stress)) + geom_smooth() + geom_point()

```
We can see that there is a plateau at around strain 0.005-0.0075.
